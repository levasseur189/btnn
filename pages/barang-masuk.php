    ...
    <div class="col-12 col-lg-8">
        <div class="card">
            <div class="card-header">
                <span><i class="bi bi-clock-history text-primary me-2"></i>Riwayat Barang Masuk</span>
                <button class="btn btn-sm btn-soft" id="refreshMasuk"><i class="bi bi-arrow-clockwise me-1"></i> Refresh</button>
            </div>
            <div class="card-body" id="masukBody">
                <?php if (empty($rows)): ?>
...
refreshSection('refreshMasuk', 'masukBody', 'masuk');
";
